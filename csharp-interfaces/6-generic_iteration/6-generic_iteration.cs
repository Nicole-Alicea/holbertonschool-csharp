...
/// <summary>
/// Represents a generic class that creates a collection of type T objects that can be iterated through.
/// </summary>
/// <typeparam name="T"> The type of objects to store in the collection. </typeparam>
class Objs<T> : IEnumerable<T>
{
    /// <summary>
    /// Internal list used to store objects of type T.
    /// </summary>
    List<T> list_a = new List<T>();
    ...
    /// </summary>
    /// <returns> An enumerator of type T for the collection. </returns>
    public IEnumerator<T> GetEnumerator()
    {
        return (list_a.GetEnumerator());
    }
