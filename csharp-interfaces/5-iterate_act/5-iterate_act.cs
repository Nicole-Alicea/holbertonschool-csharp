...
/// <summary>
/// A class that represents a Room Object.
/// </summary>
class RoomObjects
{
    /// <summary>
    /// Iterates through a list of room objects and performs actions based on their type.
    /// </summary>
    /// <param name="roomObjects"> A list of objects to be iterated over. </param>
    /// <param name="type"> The type of interface to check against. </param>
